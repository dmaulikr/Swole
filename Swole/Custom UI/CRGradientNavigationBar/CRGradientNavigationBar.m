    ...
    if (barTintGradientColors != nil)
    {
        ...
        [barTintGradientColors enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
            ...
            else
            {
                ...
                @throw [NSException exceptionWithName:@"BarTintGradientColorsError" reason:@"object in barTintGradientColors array is not a UIColor or CGColorRef" userInfo:nil];
            }
        }];
