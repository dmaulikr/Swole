...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _titleLabel.font = [UIFont fontWithName:@"AvenirNext-Regular" size:30];
        _titleLabel.textColor = [UIColor blackColor];
        _titleLabel.shadowColor = [UIColor ht_leadDarkColor];
        ...
        _subtitleLabel.font = [UIFont fontWithName:@"AvenirNext-Regular" size:18];
        _subtitleLabel.textAlignment = NSTextAlignmentCenter;
        _subtitleLabel.textColor = [UIColor blackColor];
        _subtitleLabel.shadowColor = [UIColor ht_leadDarkColor];
