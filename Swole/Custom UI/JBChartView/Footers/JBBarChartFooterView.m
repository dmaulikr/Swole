...
+ (void)initialize
{
	...
	{
        kJBBarChartFooterViewDefaultBackgroundColor = [UIColor ht_cloudsColor];
	}
}
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _leftLabel.font = [UIFont fontWithName:@"AvenirNext-Regular" size:12.f];
        _leftLabel.textAlignment = NSTextAlignmentLeft;
        _leftLabel.textColor = [UIColor blackColor];
        _leftLabel.shadowColor = [UIColor ht_leadDarkColor];
        ...
        _rightLabel.font = [UIFont fontWithName:@"AvenirNext-Regular" size:12.f];
        _rightLabel.textAlignment = NSTextAlignmentRight;
        _rightLabel.textColor = [UIColor blackColor];
        _rightLabel.shadowColor = [UIColor ht_leadDarkColor];
