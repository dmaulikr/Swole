...
- (void)initialize
{
    ...
    NSArray *weekSymbols = [_calendar veryShortStandaloneWeekdaySymbols]; //edited
    ...
    topBorderLayer.backgroundColor = [[UIColor grayColor] colorWithAlphaComponent:0.2].CGColor; //edited
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.entryListViewControllerDelegate = self.entryListViewControllerDelegate;
    [cell setNeedsLayout];
    return cell;
}
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell.isPlaceholder) {
        ...
        [self scrollToDate:cell.date animate:YES]; //edited
    } else {
