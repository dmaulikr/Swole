...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _autoAdjustTitleSize = NO;
        //edited
        _titleFont        = [UIFont fontWithName:@"AvenirNext-Regular" size:19];_subtitleFont     = [UIFont fontWithName:@"AvenirNext-Regular" size:17];
        _weekdayFont      = [UIFont fontWithName:@"AvenirNext-Bold" size:18];        _headerTitleFont  = [UIFont fontWithName:@"AvenirNext-Regular" size:25];
