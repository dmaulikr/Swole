...
- (void)show
{
    ...
    // Attached to the top most window
            ...
            dialogView.frame = CGRectMake((screenSize.width - dialogSize.width) / 2, screenSize.height *.3f, dialogSize.width, dialogSize.height);
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton.titleLabel setFont:[UIFont fontWithName:@"AvenirNext-Regular" size:14.0f]];
...
- (void)changeOrientationForIOS8: (NSNotification *)notification {
    ...
    [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionTransitionNone
                     animations:^{
                         ...
                         dialogView.frame = CGRectMake((screenWidth - dialogSize.width) / 2, screenHeight *.3f / 2, dialogSize.width, dialogSize.height);
                     }
                     completion:nil
     ];
...
- (void)keyboardWillShow: (NSNotification *)notification
{
    ...
    //edited to bring the alert view closer to the keyboard (*1.2f)
    [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionTransitionNone
					 animations:^{
                         dialogView.frame = CGRectMake((screenSize.width - dialogSize.width) / 2, screenSize.height *.3f, dialogSize.width, dialogSize.height);
					 }
